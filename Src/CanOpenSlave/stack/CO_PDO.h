 ...
 * 0x1800+. PDO mapping parameters (dataLength and contents of the PDO) are in Object
...
typedef struct{
    ...
    /** Location and dataLength of the mapped object. Bit meanings `0xIIIISSLL`:
