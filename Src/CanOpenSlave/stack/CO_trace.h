...
typedef struct {
    ...
    uint32_t (*printPointStart)(char *s, uint32_t dataLength, uint32_t timeStamp, int32_t value);
    /** Function pointer for printing the point to trace.plot */
    uint32_t (*printPoint)(char *s, uint32_t dataLength, uint32_t timeStamp, int32_t value);
    /** Function pointer for printing the end point to trace.plot */
    uint32_t (*printPointEnd)(char *s, uint32_t dataLength, uint32_t timeStamp, int32_t value);
} CO_trace_dataType_t;
