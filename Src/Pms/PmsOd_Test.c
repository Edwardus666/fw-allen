...
/*1A0B*/ {0x3, 0x30001310L, 0x30000D10L, 0x30000E10L, 0x0L, 0x0L, 0x0L, 0x0L, 0x0L}},
...
/*0x2120*/ const CO_OD_entryRecord_t PMS_OD_record2120[6] = {
		   {(void*)& PMS_CO_OD_RAM.testVar.maxSubIndex, 0x06,  1},
		   {(void*)& PMS_CO_OD_RAM.testVar.I64, 0xBE,  8},
		   {(void*)& PMS_CO_OD_RAM.testVar.U64, 0xBE,  8},
		   {(void*)& PMS_CO_OD_RAM.testVar.R32, 0xBE,  4},
		   {(void*)& PMS_CO_OD_RAM.testVar.R64, 0xBE,  8},
		   {0, 0x0E,  0} };
...
{0x1801, 0x06, 0x00,  0, (void*)& PMS_OD_record1801},
{0x1802, 0x06, 0x00,  0, (void*)& PMS_OD_record1802},
{0x1803, 0x06, 0x00,  0, (void*)& PMS_OD_record1803},
{0x1804, 0x06, 0x00,  0, (void*)& PMS_OD_record1804},
{0x1805, 0x06, 0x00,  0, (void*)& PMS_OD_record1805},
{0x1806, 0x06, 0x00,  0, (void*)& PMS_OD_record1806},
{0x1807, 0x06, 0x00,  0, (void*)& PMS_OD_record1807},
{0x1808, 0x06, 0x00,  0, (void*)& PMS_OD_record1808},
{0x1809, 0x06, 0x00,  0, (void*)& PMS_OD_record1809},
{0x180A, 0x06, 0x00,  0, (void*)& PMS_OD_record180A},
{0x180B, 0x06, 0x00,  0, (void*)& PMS_OD_record180B},
...
{0x2107, 0x05, 0xBE,  2, (void*)& PMS_CO_OD_RAM.performance[0]},
{0x2108, 0x01, 0xB6,  2, (void*)& PMS_CO_OD_RAM.temperature[0]},
{0x2109, 0x01, 0xB6,  2, (void*)& PMS_CO_OD_RAM.voltage[0]},
{0x2110, 0x10, 0xFE,  4, (void*)& PMS_CO_OD_RAM.variableInt32[0]},
{0x2111, 0x10, 0xFD,  4, (void*)& PMS_CO_OD_ROM.variableROMInt32[0]},
{0x2112, 0x10, 0xFF,  4, (void*)& PMS_CO_OD_EEPROM.variableNVInt32[0]},
{0x2120, 0x05, 0x00,  0, (void*)& PMS_OD_record2120},
...
#define PMS_OD(ind)	\
	...
	{0x301A, 0x00, 0x00, 0, Null},		/*Pms固件*/														\

const CO_OD_entry_t g_Pms_0_Od[] = { PMS_OD(0) };
const CO_OD_entry_t g_Pms_1_Od[] = { PMS_OD(1) };
const CO_OD_entry_t g_Pms_2_Od[] = { PMS_OD(2) };
const CO_OD_entry_t g_Pms_3_Od[] = { PMS_OD(3) };
const CO_OD_entry_t g_Pms_4_Od[] = { PMS_OD(4) };
const CO_OD_entry_t g_Pms_5_Od[] = { PMS_OD(5) };
const CO_OD_entry_t g_Pms_6_Od[] = { PMS_OD(6) };
const CO_OD_entry_t g_Pms_7_Od[] = { PMS_OD(7) };
const CO_OD_entry_t g_Pms_8_Od[] = { PMS_OD(8) };
const CO_OD_entry_t g_Pms_9_Od[] = { PMS_OD(9) };
const CO_OD_entry_t g_Pms_10_Od[] = { PMS_OD(10) };
const CO_OD_entry_t g_Pms_11_Od[] = { PMS_OD(11) };
const CO_OD_entry_t g_Pms_12_Od[] = { PMS_OD(12) };
const CO_OD_entry_t g_Pms_13_Od[] = { PMS_OD(13) };
const CO_OD_entry_t g_Pms_14_Od[] = { PMS_OD(14) };
