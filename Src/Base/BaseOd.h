...
#include "Od.h"
	...
	#define PMS_OD_SIZE 29


	/*******************************************************************************
	   STRUCTURES FOR VARIABLES IN DIFFERENT MEMORY LOCATIONS
	*******************************************************************************/
#define  BASE_CO_OD_FIRST_LAST_WORD     0x55 //Any value from 0x01 to 0xFE. If changed, EEPROM will be reinitialized.

	/***** Structure for RAM variables ********************************************/
	//struct sBASE_CO_OD_RAM {
	//	UNSIGNED32     FirstWord;

	//	/*1001      */ UNSIGNED8      errorRegister;
	//	/*1002      */ UNSIGNED32     manufacturerStatusRegister;
	//	/*1003      */ UNSIGNED32     preDefinedErrorField[8];
	//	///*1010      */ UNSIGNED32     storeParaBASEs[1];
	//	///*1011      */ UNSIGNED32     restoreDefaultParaBASEs[1];
	...
	struct sBASE_CO_OD_ROM {
		...
		///*1200[1]   */ OD_SDOServerPara_t SDOServerPara[1];
	...
	//extern struct sBASE_CO_OD_RAM BASE_CO_OD_RAM;

	//extern struct sBASE_CO_OD_EEPROM BASE_CO_OD_EEPROM;

	extern struct sBASE_CO_OD_ROM BASE_CO_OD_ROM;
	extern const CO_OD_entry_t g_pBaseOd[];

	extern const CO_OD_entryRecord_t BASE_OD_record1400[3];
	extern const CO_OD_entryRecord_t BASE_OD_record1401[3];
	extern const CO_OD_entryRecord_t BASE_OD_record1402[3];
	extern const CO_OD_entryRecord_t BASE_OD_record1403[3];

	extern const CO_OD_entryRecord_t BASE_OD_record1800[7];
	extern const CO_OD_entryRecord_t BASE_OD_record1801[7];
	extern const CO_OD_entryRecord_t BASE_OD_record1802[7];
	extern const CO_OD_entryRecord_t BASE_OD_record1803[7];
