#ifndef __SHELF_LOCK_OD_H_
#define __SHELF_LOCK_OD_H_
...
#include "BaseOd.h"
	...
	#define SHELF_LOCK_OD_SIZE 22


	/*******************************************************************************
	   STRUCTURES FOR VARIABLES IN DIFFERENT MEMORY LOCATIONS
	*******************************************************************************/
#define  SHELF_LOCK_OD_FIRST_LAST_WORD     0x55 //Any value from 0x01 to 0xFE. If changed, EEPROM will be reinitialized.

	/***** Structure for RAM variables ********************************************/
	struct sSHELF_LOCK_OD_OD_RAM {
		...
		///*2120      */ SHELF_LOCK_OD_testVar_t   testVar;
		///*2130      */ SHELF_LOCK_OD_time_t      time;
	...
	struct sSHELF_LOCK_OD_OD_EEPROM {
		UNSIGNED32     FirstWord;
	...
	struct sSHELF_LOCK_OD_ROM {
		...
		/*1600[4]   */ OD_RPDOMappingParameter_t RPDOMappingParameter[1];
		///*1800[4]   */ OD_TPDOCommunicationParameter_t TPDOCommunicationParameter[4];
		/*1A00[4]   */ OD_TPDOMappingParameter_t TPDOMappingParameter[1];
	...
	extern struct sSHELF_LOCK_OD_OD_RAM SHELF_LOCK_OD_OD_RAM;

	extern struct sSHELF_LOCK_OD_OD_EEPROM SHELF_LOCK_OD_OD_EEPROM;

	extern struct sSHELF_LOCK_OD_ROM SHELF_LOCK_OD_ROM;
	extern const CO_OD_entry_t g_ShelfLockOd[];
#ifdef __cplusplus
}
#endif
