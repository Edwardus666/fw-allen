...
*******************************************************************************/
   ...
   #define CO_NO_TPDO                     12   //Associated objects: 1800, 1801, 1802, 1803, 1A00, 1A01, 1A02, 1A03
...
/*2000      */ typedef struct {
	UNSIGNED8     maxSubIndex;
	UNSIGNED8	  shelfWaterIn;		//机柜进水检测，0：没进水；1：进水
	UNSIGNED8	  BucketWaterLevel;	//水桶水位检测，0：水位低；1：正常。
	UNSIGNED8	  lightPowerOn;		//照明灯开关；0：关；1：开。
	UNSIGNED8	  lcdPowerOn;		//LCD供电开关；0：关；1：开
	UNSIGNED8	  ccuTemp1;			//温度传感器1的温度值
	UNSIGNED8	  ccuTemp2;			//温度传感器2的温度值
	UNSIGNED8	  ccuTemp3;			//温度传感器3的温度值
	UNSIGNED8	  ccuTemp4;			//温度传感器4的温度值
	UNSIGNED8	  funPowerOn;		//风扇是否供电，0：断电；1：供电。
}              OD_Cabinet_t;

/*2001-2004 */ typedef struct{
               UNSIGNED8      maxSubIndex;
			   UNSIGNED8	  powerOn;		//风扇供电状态；0：断电；1：供电
			   UNSIGNED8	  workState;	//风扇的运行状态
			   UNSIGNED8	  funFault;		//风扇的故障状态
               }              OD_Fun_t;

/*2005      */ typedef struct{
               UNSIGNED8      maxSubIndex;
			   UNSIGNED8	  powerOn;	//风扇供电状态,0：断电；1：上电
			   UNSIGNED8	  Fault;	//故障状态
               }              OD_Pump_t;

/*2007      */ typedef struct{
               UNSIGNED8      maxSubIndex;
			   UNSIGNED16	  DischargeCurrent;	//18650充电电流 mA
			   UNSIGNED16	  Voltage;			//18650电压，单位mV
			   UNSIGNED8	  Temp;				//18650温度，单位摄氏度，偏移+40度。
			   UNSIGNED8	  convertState;		//18650升压12V输出检测,0：正常;1：故障。
}              OD_18650Bat_t;

/*2110-2014 */ typedef struct{
               UNSIGNED8      maxSubIndex;
			   UNSIGNED8	  powerOn;	//继电器供电状态,0：断电；1：上电
			   UNSIGNED8	  Fault;	//故障状态
               }              OD_Relay_t;
...
/*100A      */ VISIBLE_STRING manufacturerSoftwareVersion[11];
/*1010      */ UNSIGNED32     storeParameters[1];
/*1011      */ UNSIGNED32     restoreDefaultParameters[1];

/*2000      */ OD_Cabinet_t	  cabinet;		//备用电源模块12V输出检测，0：正常;1：故障

/*2001      */ OD_Fun_t  	  Fun1;		//风扇1状态
/*2002      */ OD_Fun_t  	  Fun2;		//风扇2状态
/*2003      */ OD_Fun_t  	  Fun3;		//风扇3状态
/*2004      */ OD_Fun_t  	  Fun4;		//风扇4状态
/*2005      */ OD_Pump_t	  pump;		//水泵的状态

/*2007      */ OD_18650Bat_t  _18650Bat;	//18650充电电流 mA

/*2008      */ OD_Fun_t  	  Fun5;		//风扇5状态
/*2009      */ OD_Fun_t  	  Fun6;		//风扇6状态

/*2010      */ OD_Relay_t	  relay1;	//1号继电器
/*2011      */ OD_Relay_t	  relay2;	//2号继电器
/*2012      */ OD_Relay_t	  relay3;	//3号继电器
/*2013      */ OD_Relay_t	  relay4;	//4号继电器
/*2014      */ OD_Relay_t	  relay5;	//5号继电器

/*2020      */ UNSIGNED8	 BU_board_present;	//备电板是否在位
...
/*1800[12]  */ OD_TPDOCommunicationParameter_t TPDOCommunicationParameter[CO_NO_TPDO];
/*1A00[12]  */ OD_TPDOMappingParameter_t TPDOMappingParameter[CO_NO_TPDO];
...
/*1016, Data Type: UNSIGNED32, Array[4] */
      ...
      #define ODL_consumerHeartbeatTime_arrayLength      4	//Allen modified: 4->0
...
/*1A00[4], Data Type: OD_TPDOMappingParameter_t, Array[12] */
...
#define OD_shelfWaterIn CO_OD_RAM.cabinet.shelfWaterIn
#define OD_waterLevel	CO_OD_RAM.cabinet.BucketWaterLevel
#define OD_lightPowerOn CO_OD_RAM.cabinet.lightPowerOn
#define OD_lcdPowerOn	CO_OD_RAM.cabinet.lcdPowerOn
#define OD_funPowerOn	CO_OD_RAM.cabinet.funPowerOn
#define OD_ccuTemp1		CO_OD_RAM.cabinet.ccuTemp1
#define OD_ccuTemp2		CO_OD_RAM.cabinet.ccuTemp2
#define OD_ccuTemp3		CO_OD_RAM.cabinet.ccuTemp3
#define OD_ccuTemp4		CO_OD_RAM.cabinet.ccuTemp4

#define OD_fun1Fault	CO_OD_RAM.Fun1.funFault
#define OD_fun2Fault	CO_OD_RAM.Fun2.funFault
#define OD_fun3Fault	CO_OD_RAM.Fun3.funFault
#define OD_fun4Fault	CO_OD_RAM.Fun4.funFault
#define OD_fun5Fault	CO_OD_RAM.Fun5.funFault
#define OD_fun6Fault	CO_OD_RAM.Fun6.funFault

#define OD_pumpPowerOn	CO_OD_RAM.pump.powerOn

#define OD_relay1PowerOn	CO_OD_RAM.relay1.powerOn
#define OD_relay2PowerOn	CO_OD_RAM.relay2.powerOn
#define OD_relay3PowerOn	CO_OD_RAM.relay3.powerOn
#define OD_relay4PowerOn	CO_OD_RAM.relay4.powerOn

#define OD_18650Current	CO_OD_RAM._18650Bat.DischargeCurrent
#define OD_18650Voltage	CO_OD_RAM._18650Bat.Voltage

#define BU_isPresent	CO_OD_RAM.BU_board_present

//Allen add;
extern const uint16 TPDO_CAN_ID[CO_NO_TPDO];
extern const uint16 RPDO_CAN_ID[CO_NO_RPDO];
